...
try:
    ...
    tn.write(b"comando_a_enviar\n")  # Reemplaza "comando_a_enviar" con el comando que deseas enviar
    print(tn.read_all().decode('utf-8'))  # Imprime la respuesta del servidor
    tn.close()
